...
/****
	 * Create a new GridWriter. It is initially empty. It has the capacity to 
           store four GridItems before it
	 
         * will need to double its array size. The row and column arguments are 
           used in the display method, to 
...
/****
	 * The display method prints a grid into standard output. The size of the 
           grid is determined by the row and 
